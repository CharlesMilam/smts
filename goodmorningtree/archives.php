...
<?php	    if (have_posts()) :
		while (have_posts()) : the_post(); ?>
			...
			<div class="post-top">
			    <h2><?php esc_html_e('Archive Index Page', 'cloud_clarity'); ?></h2>
			</div>
			<div class="entry">
...
<?php	    endif; ?>
	    ...
	    <h2><?php esc_html_e('Archives by Year:', 'cloud_clarity'); ?></h2>
	    <ul class="list-10">
		<?php wp_get_archives('type=yearly'); ?>
	    </ul>

	    <h2><?php esc_html_e('Archives by Month:', 'cloud_clarity'); ?></h2>
	    <ul class="list-10">
		<?php wp_get_archives('type=monthly'); ?>
	    </ul>

	    <h2><?php esc_html_e('Archives by Subject:', 'cloud_clarity'); ?></h2>
	    <ul class="list-10">
