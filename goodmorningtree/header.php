...
<body <?php body_class(); ?>>
	...
	<div id="top-container" class="container_24">
		...
		<div id="menu" >
            ...
            <a id="btn_2" href="<?php bloginfo('wpurl'); ?>/tree-service-austin-tx" title="Our Tree Services">SERVICES</a>

            <a id="btn_3" href="<?php bloginfo('wpurl'); ?>/about-us" title="About Us">ABOUT US</a>

            <a id="btn_4" href="<?php bloginfo('wpurl'); ?>/our-work-gallery" class="lines2" title="Reference Gallery">REFERENCE GALLERY</a>

            <a id="btn_5" href="<?php bloginfo('wpurl'); ?>/job-estimate" title="Estimates">ESTIMATES</a>
