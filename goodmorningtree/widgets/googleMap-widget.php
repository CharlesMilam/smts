...
class Google_Map_Widget extends WP_Widget {
	...
	function Google_Map_Widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_googlemap', 'description' => esc_html__('A Google Map widget.', 'qualifire') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 350, 'height' => 350, 'id_base' => 'googlemap-widget' );

		/* Create the widget. */
		$this->WP_Widget( 'googlemap-widget', esc_html__('QualiFire: Google Map', 'qualifire'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => esc_html__('Google Map', 'qualifire'), 'googlemap_code' => '' );
		...
		<p>
		    <label for="<?php echo $this->get_field_id( 'googlemap_code' ); ?>"><?php esc_html_e('Google Map Code:', 'qualifire'); ?></label>
