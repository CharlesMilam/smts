...
function pagenavi_menu() {
	if (function_exists('add_options_page')) {
		add_options_page(__('PageNavi', 'qualifire'), __('PageNavi', 'qualifire'), 'manage_options', 'wp-pagenavi/pagenavi-options.php') ;
	}
}
...
function pagenavi_init() {
	...
	$pagenavi_options['pages_text'] = __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','qualifire');
	$pagenavi_options['current_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['page_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['first_text'] = __('&laquo; First','qualifire');
	$pagenavi_options['last_text'] = __('Last &raquo;','qualifire');
	$pagenavi_options['next_text'] = __('&raquo;','qualifire');
	$pagenavi_options['prev_text'] = __('&laquo;','qualifire');
	$pagenavi_options['dotright_text'] = __('...','qualifire');
	$pagenavi_options['dotleft_text'] = __('...','qualifire');
